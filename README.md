...
コードレビューは、作成者とは異なる視点でコードをチャックすることにより、本人では気付きにくいバグ（ミス、問題点）を発見しやすく、プログラムの品質向上に役立ちます。
また、レビュアー（レビューされる人）とレビュイー（レビューする人）が、お互いコードについて意見交換をすることで、技術知識を共有することができます。
さらに、共通の評価基準（ガイドライン）を作成することで、一貫した品質を保つことができる。
